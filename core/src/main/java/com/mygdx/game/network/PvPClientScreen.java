...
public class PvPClientScreen extends GameScreen {
...
//    };
    ...
    public PvPClientScreen(FirebaseInterface fb) {
        instance = this;
...
//        try {
//            gameClient = new GameClient("192.168.1.248", 8888);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
//        playerTank.SendInputToServer(gameClient);
