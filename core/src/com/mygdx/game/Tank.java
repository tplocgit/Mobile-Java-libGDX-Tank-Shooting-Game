...
public class Tank extends GameObject implements Movable {
    ...
    public void draw(Batch batch, float deltaTime) {
        ...
        for (int i = 0; i < this.bullets.size(); ++i) {
            ...
            if (bullet.getX() > Graphic.TILE_SIZE * (Graphic.NUMBER_OF_HEIGHT_TILE - 1) || bullet.getX() < 0 ||
                    bullet.getY() > Graphic.TILE_SIZE * (Graphic.NUMBER_OF_WIDTH_TILE - 1) || bullet.getY() < 0){
                --i;
